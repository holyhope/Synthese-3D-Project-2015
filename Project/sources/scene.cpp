...
void jardindeDeadMaster() {
	...
	//
	//Sol Ext�rieur partie maison > bord piscine
	//
	...
	glPopMatrix(); // remet l'�tat d'avant les roquettes
	glPopMatrix(); //Remet l'�tat d'origine
