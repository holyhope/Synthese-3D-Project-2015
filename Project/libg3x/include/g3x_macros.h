/* ===============================================================
  ...
  #define G3Xmapvect(V,W)     (G3Xcoord){(V)[0]*(W)[0],\
                                        (V)[1]*(W)[1],\
                                        (V)[2]*(W)[2]}


  #define G3Xmapvect4(V,W)    (G3Xcolor){(V)[0]*(W)[0],\
                                        (V)[1]*(W)[1],\
                                        (V)[2]*(W)[2],\
																				(V)[3]*(W)[3]}
  ...
  #define G3Xsqrnorm(V)     ((V)[0]*(V)[0]+(V)[1]*(V)[1]+(V)[2]*(V)[2])
  /* norme du vecteur V */
  #define G3Xnorm(V)        sqrt(G3Xsqrnorm(V))
  
                               
  
  
  /* vecteur V=AB*/
  #define G3Xsetvect(V,A,B)  ((V)[0]=(B)[0]-(A)[0],\
                             (V)[1]=(B)[1]-(A)[1],\
                             (V)[2]=(B)[2]-(A)[2])
  /* V <- V+W */
  #define G3Xaddvect(V,W)    ((V)[0]+=(W)[0],\
                             (V)[1]+=(W)[1],\
                             (V)[2]+=(W)[2])
  /* V <- V-W */
  #define G3Xsubvect(V,W)    ((V)[0]-=(W)[0],\
                             (V)[1]-=(W)[1],\
                             (V)[2]-=(W)[2])
  /* V <- a*V */
  #define G3Xmulvect(V,a)    ((V)[0]*=a,\
                             (V)[1]*=a,\
                             (V)[2]*=a)

  /* normalize le vecteur V */
	#define G3Xnormalize(V)    { double __norm__=1./G3Xnorm(V); G3Xmulvect(V,__norm__); }


  /* produit scalaire  : crée le scalaire U°V */
  #define G3Xprodscal(U,V)    ((U)[0]*(V)[0]+(U)[1]*(V)[1]+(U)[2]*(V)[2])
  /* produit vectoriel : crée le vecteur U^V */
  #define G3Xprodvect(UV,U,V)  ((UV)[0]=(U)[1]*(V)[2]-(U)[2]*(V)[1],\
                               (UV)[1]=(U)[2]*(V)[0]-(U)[0]*(V)[2],\
                               (UV)[2]=(U)[0]*(V)[1]-(U)[1]*(V)[0])
  /* produit vectoriel : crée le vecteur AB^AC */
  #define G3Xprodvect3point(ABC,A,B,C)  ((ABC)[0]=((B)[1]-(A)[1])*((C)[2]-(A)[2])-((B)[2]-(A)[2])*((C)[1]-(A)[1]),\
